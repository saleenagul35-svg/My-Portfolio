      ...
      <section className="relative z-10 max-w-7xl mx-auto px-10 py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-gray-400 leading-relaxed text-lg max-w-xl">
            BS Computer Science (7th Semester) student with strong foundations
            in HTML, CSS, JavaScript, and responsive web design. Currently
            advancing my expertise through a Full-Stack Web Development course
            to strengthen backend and database skills. Passionate about building
            modern, user-focused, and performance-optimized web applications.
            A quick learner with strong problem-solving abilities and a

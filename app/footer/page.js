...
const Footer = () => {
  return (
    <footer className="bg-black text-gray-300 relative overflow-hidden mt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-10 py-16 grid md:grid-cols-3 gap-12 border-t border-yellow-600/20">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-400 leading-relaxed">
            ...
            user-friendly web experiences with Next.js and Tailwind CSS.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 mb-4">
            saleenagul@example.com
          </p>

          <div className="flex gap-4">
            <a
              href="www.linkedin.com/in/saleena-gul"
              className="hover:text-yellow-500 transition"
            >
              LinkedIn
            </a>
            <a
              href="saleenagul35-svg"
              className="hover:text-yellow-500 transition"
            >
              GitHub
            </a>
